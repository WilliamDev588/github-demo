                                    ...
                                    @foreach(session('cart') as $id => $details)
                                        <tr>
                                            <th scope="row" class="border-0">
                                                <div class="p-2">
                                                    <img src="{{Storage::url($details['image']) }}" alt="" width="70" class="img-fluid rounded shadow-sm">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="p-4">
                                ...
                                <div class="input-group mb-4 border rounded-pill p-2">
                                    <input type="text" name="number" placeholder="Enter Card Number" class="form-control" required />
