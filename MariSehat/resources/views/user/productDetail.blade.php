...
<h1>Product Details</h1>
    ...
    <div class="p-5 mb-4 bg-light rounded-3">
        <div class="container-fluid py-5">
          ...
          <h1 class="display-5 fw-bold">Barbel</h1>
          <p class="col-md-8 fs-4">YA GITU DAAHHH BUAT DI ANGKAT POKOKNYA YE</p>
          <button class="btn btn-primary btn-lg" type="button">BUY NOW PLEAZE</button>
        </div>
      </div>
